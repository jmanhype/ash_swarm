defmodule Mix.Tasks.AshSwarm.ApplyPatches do
  ...
  * `--verbose` - Output detailed information
  ...
  alias AshSwarm.Foundations.IgniterSemanticPatching
  ...
  def run(args) do
    ...
    # Since we're using the Example module, we'll use it directly
    # In a real implementation, we would likely implement a module lookup system
    # to find patch definitions from various modules
